            ...
            if (resultc > -1) {
                ...
                if (corecommand.equals("rollback") || corecommand.equals("restore") || corecommand.equals("rb") || corecommand.equals("rs") || corecommand.equals("ro") || corecommand.equals("re")) {
                    ...
                    if (!VersionUtils.validDonationKey()) {
                        Chat.sendMessage(user,Color.GREY + "[" + Color.DARK_AQUA + Color.BOLD + "CP" + Color.GREY + "] " + Color.WHITE + Phrase.build(Phrase.DONATION_KEY_REQUIRED));
                    }
                    else {
                    ...
                    Chat.sendMessage(user,Color.GREY + "[" + Color.DARK_AQUA + Color.BOLD + "CP" + Color.GREY + "] " + Color.WHITE + Phrase.build(Phrase.COMMAND_NOT_FOUND, Color.WHITE, "/co " + corecommand));
                }
            }
            else {
